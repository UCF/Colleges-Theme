...
(function ($) {
  ...
  function enableBgVideoAutoplay() {
    if (Cookies.get('ucfcollege-autoplay-bg-videos') !== '1') {
      Cookies.set('ucfcollege-autoplay-bg-videos', '1');
    }
  }

  function disableBgVideoAutoplay() {
    if (Cookies.get('ucfcollege-autoplay-bg-videos') !== '0') {
      Cookies.set('ucfcollege-autoplay-bg-videos', '0');
    }
  }
  ...
  function init() {
    if ($videos.length && $btns.length) {
      ...
      if (typeof Cookies.get('ucfcollege-autoplay-bg-videos') === 'undefined') {
        Cookies.set('ucfcollege-autoplay-bg-videos', '1', {
          expires: 365,
          domain: UCFCOLLEGE.domain
        });
      }
