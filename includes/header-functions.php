 ...
 **/
if( !function_exists( 'get_sitename_formatted' ) ) {
 ...
 **/
if( !function_exists( 'get_header_videos' ) ) {
 ...
 **/
if( !function_exists( 'get_header_subtitle' ) ) {
 ...
 **/
if( !function_exists( 'get_homepage_header_cta' ) ) {
 ...
 **/
if( !function_exists( 'get_homepage_header_markup' ) ) {
 ...
 **/
if( !function_exists( 'get_header_media_content_markup' ) ) {
 ...
 **/
if( !function_exists( 'get_header_media_markup' ) ) {
 ...
 **/
if( !function_exists( 'get_header_default_markup' ) ) {
...
if( !function_exists( 'get_header_markup' ) ) {
