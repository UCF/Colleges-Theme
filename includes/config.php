...
function __init__() {
	...
	add_image_size( 'header-img-sm', 767, 600, true );
	add_image_size( 'header-img-md', 991, 600, true );
	add_image_size( 'header-img-lg', 1199, 600, true );
	add_image_size( 'header-img-xl', 1600, 600, true );
